#include "../includeopengl/VKUtils.h"
#include "../includeopengl/CommonUtils.h"
#include "../includeopengl/Log.h"
#include "../includeopengl/VKVideoRendererYUV420.h"
...
void VKVideoRendererYUV420::updateUniformBuffers() {
    ...
    mat4f_load_ortho1(-1.0f, 1.0f, -targetAspectRatio, targetAspectRatio, -1.0f, 1.0f,
                     m_ubo.projection);

    mat4f_load_rotation_z1(m_rotation + 180, m_ubo.rotation);

    float scaleFactor = aspect_ratio_correction1(false, m_backingWidth, m_backingHeight, m_width,
                                                m_height);

    mat4f_load_scale1(scaleFactor, scaleFactor, 1.0f, m_ubo.scale);
}
