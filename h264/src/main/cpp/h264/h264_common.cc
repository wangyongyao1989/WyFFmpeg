...
bool byte_aligned(rtc264::BitBuffer *bit_buffer) {
...
int get_current_offset(rtc264::BitBuffer *bit_buffer) {
  size_t out_byte_offset, out_bit_offset;
  bit_buffer->GetCurrentOffset(&out_byte_offset, &out_bit_offset);
...
bool more_rbsp_data(rtc264::BitBuffer *bit_buffer) {
...
bool rbsp_trailing_bits(rtc264::BitBuffer *bit_buffer) {
  uint32_t bits_tmp;
