...
#include "../h264include/h264nal/h264_vui_parameters_parser.h"
...
// Unpack RBSP and parse SPS data state from the supplied buffer.
    ...
    std::unique_ptr<H264SpsDataParser::SpsDataState>
    H264SpsDataParser::ParseSpsData(rtc264::BitBuffer *bit_buffer) noexcept {
        uint32_t bits_tmp;
        int32_t golomb_tmp;
...
// Section 7.3.2.1.1.1
    bool H264SpsDataParser::SpsDataState::scaling_list(
            rtc264::BitBuffer *bit_buffer, uint32_t i, std::vector<uint32_t> &scalingList,
...
// Unpack RBSP and parse SPS state from the supplied buffer.
    ...
    std::shared_ptr<H264SpsParser::SpsState> H264SpsParser::ParseSps(
            rtc264::BitBuffer *bit_buffer) noexcept {
