...
#include "../h264include/h264nal/h264_nal_unit_payload_parser.h"
...
#include "../h264include/h264nal/h264_bitstream_parser_state.h"
#include "../h264include/h264nal/h264_common.h"
#include "../h264include/h264nal/h264_pps_parser.h"
#include "../h264include/h264nal/h264_prefix_nal_unit_parser.h"
#include "../h264include/h264nal/h264_slice_layer_extension_rbsp_parser.h"
#include "../h264include/h264nal/h264_slice_layer_without_partitioning_rbsp_parser.h"
#include "../h264include/h264nal/h264_sps_parser.h"
#include "../h264include/h264nal/h264_subset_sps_parser.h"
...
// Unpack RBSP and parse NAL Unit payload state from the supplied buffer.
    ...
    H264NalUnitPayloadParser::ParseNalUnitPayload(
        ...
        rtc264::BitBuffer bit_buffer(unpacked_buffer.data(), unpacked_buffer.size());
    ...
    std::unique_ptr<H264NalUnitPayloadParser::NalUnitPayloadState>
    H264NalUnitPayloadParser::ParseNalUnitPayload(
            rtc264::BitBuffer *bit_buffer, uint32_t nal_ref_idc, uint32_t nal_unit_type,
            struct H264BitstreamParserState *bitstream_parser_state) noexcept {
        H264NalUnitHeaderParser::NalUnitHeaderState nal_unit_header;
